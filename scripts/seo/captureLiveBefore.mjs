...
const outputDir = path.resolve("./audit-artifacts/before-screenshots");
...
console.log("Capturing LIVE BEFORE screenshots...");
...
console.log("All LIVE BEFORE screenshots captured in ./audit-artifacts/before-screenshots/");
